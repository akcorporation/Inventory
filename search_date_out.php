...
if(isset($_REQUEST['startdate']) || isset($_REQUEST['enddate'])){
	...
	$q=$db->query("SELECT item_name,item_unit,unit_sym,item_master.id,item_master.item_quantity,item_date,item_master.ward_id FROM item_detail_master,item_master,unit_master WHERE in_out_type=$type AND item_detail_master.id=item_master.item_id AND unit_master.id=item_unit $condition order by id desc") or die("");
							$i=0;
