				  ...
				  <div class="col-lg-12">
					...
					<div class="col-lg-12">
						<ul class="nav nav-tabs">
							...
							<li class="active"><a href="manage_item_record.php">Item Returned</a></li>
					...
					<table id="example1" class="table table-middle dataTable table-bordered table-condensed table-hover">
                            ...
                            <tbody id="table_show">
							<?php 
							$q=$db->query("SELECT item_name,item_unit,unit_sym,item_master.id,item_master.item_quantity,item_date,item_master.ward_id FROM item_detail_master,item_master,unit_master WHERE in_out_type=3 AND item_detail_master.id=item_master.item_id AND unit_master.id=item_unit order by id desc") or die("");
							$i=0;
